 ...
 * @UniqueEntity(
 *  fields={"title"},
 *  message="Une annonce possede déja ce titre"
 * )
 */
class Ad
{
    ...
    /**
     * Permet de récuperer le commentaire d'un autheur par rapport à une annonce
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * Permet d'obtenir la moyennne globale des notes pour cette annonce
     *
     * @return float
     */
    public function getAvgRatings(){
        ...
        //faire la division pour avoir la somme
    ...
    /**
     * Permet d'obtenir un tableau d'objet des jours qui ne sont pas disponible pour cette annonce
     * 
