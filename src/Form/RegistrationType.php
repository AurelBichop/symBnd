...
class RegistrationType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('passwordConfirm', PasswordType::class,$this->getConfiguration('Confirmation de votre mot de passe', 'Veillez confirmer votre mot de passe'))
            ->add('introduction',TextType::class,$this->getConfiguration('Introduction', 'Présentez vous en quelque mots...'))
            ->add('description',TextareaType::class,$this->getConfiguration('Description détaillée', "C'est le moent de vous présenter en détails"))
