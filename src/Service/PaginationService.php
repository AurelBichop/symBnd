 ...
 * 
 * lien du fichier optimisé
 * https://github.com/liorchamla/formation-symfony/blob/master/src/Service/PaginationService.php
 */
class PaginationService {
    ...
    public function getPages(){
        if(empty($this->entityClass)){
            ...
            utiliser la méthode setEntityClass");
        }
